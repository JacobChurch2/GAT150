...
#define EVENT_SUBSCRIBE(id, function)	kda::EventManager::Instance().Subscribe(id, this, std::bind(&function, this, std::placeholders::_1))
#define EVENT_UNSUBSCRIBE(id)			kda::EventManager::Instance().Unsubscribe(id, this)
